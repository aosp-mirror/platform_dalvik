 ...
 */
// Modifications by Damien Octeau Copyright (C) 2011 The Pennsylvania State University
...
abstract class ReservedWords {
    ...
    reserved_words.put(".class_attribute", new Symbol(sym.DCLASS_ATTR));
        ...
        // Modifications by Damien Octeau
        // Using different reserved words, the old ones conflict with class
        // names in some instructions
        reserved_words.put("from__reserved__jasmin", new Symbol(sym.FROM));
        reserved_words.put("method__reserved__jasmin", new Symbol(sym.METHOD));
        reserved_words.put("to__reserved__jasmin", new Symbol(sym.TO));
        reserved_words.put("is__reserved__jasmin", new Symbol(sym.IS));
        reserved_words.put("using__reserved__jasmin", new Symbol(sym.USING));
        // End modifications by Damien Octeau
